...
public class ArcSeekBar extends View {
    ...
    private static final int DEFAULT_BORDER_COLOR = 0xffEE7900; // 默认描边颜色

    private static final int DEFAULT_THUMB_COLOR = 0xffEE7900; // 拖动按钮颜色

    private static final int DEFAULT_THUMB_WIDTH = 2; // 拖动按钮描边宽度 dp

    private static final int DEFAULT_THUMB_RADIUS = 10; // 拖动按钮半径 dp

    private static final int DEFAULT_THUMB_SHADOW_RADIUS = 0; // 拖动按钮阴影半径 dp

    private static final int DEFAULT_THUMB_SHADOW_COLOR = 0xffEE7900; // 拖动按钮阴影颜色
