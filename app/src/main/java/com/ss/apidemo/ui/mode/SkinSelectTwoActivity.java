    ...
    public void selectClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_skin_ok:
                if (skin_type == 0){
                    ToastUtil.showToast(SkinSelectTwoActivity.this, getResources().getString(R.string.select_skin));
                    return;
                }
                if (body_type == 0){
                    ToastUtil.showToast(SkinSelectTwoActivity.this, getResources().getString(R.string.select_body));
                    return;
                }
                startA();
                break;
