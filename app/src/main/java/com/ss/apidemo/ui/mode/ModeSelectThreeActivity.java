...
public class ModeSelectThreeActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        iv_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PlayVoiceUtils.startPlayVoice(MyApplication.instance(), AppConfig.KEY);
                startActivity(new Intent(ModeSelectThreeActivity.this, SplashActivity.class));
            }
        });
...
//        tv_content1.setTextColor(getResources().getColor(R.color.handgear_select));
    ...
    public void tabClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_select1:
                tv_select1.setBackground(getResources().getDrawable(R.drawable.mode_three_bt_select_corners));
                tv_select1.setTextColor(getResources().getColor(R.color.white));
                startA(1);
                break;
            case R.id.tv_select2:
                tv_select2.setBackground(getResources().getDrawable(R.drawable.mode_three_bt_select_corners));
    ...
    private void resetMenuState() {
        tv_select1.setBackground(getResources().getDrawable(R.drawable.mode_three_bt_unselect_corners));
        tv_select2.setBackground(getResources().getDrawable(R.drawable.mode_three_bt_unselect_corners));
        tv_select1.setTextColor(getResources().getColor(R.color.mode_three_bt_unselect));
        tv_select2.setTextColor(getResources().getColor(R.color.mode_three_bt_unselect));
