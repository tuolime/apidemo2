...
public class WorkSelectSixActivity extends BaseActivity {
...
//    private int seekbar_count = 4;//因为弧形进度条不能设置最小值，默认最小值为0，而手具的最小值为4,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_select_six);
        initView();
        initIntentData();
        initData();
    }
...
//        tv_max = findViewById(R.id.tv_max);
    ...
    private void initData() {
        ...
        tv_raedy.setTextColor(getResources().getColor(R.color.work_two_fan_select));
        ...
        switch (view.getId()) {
            case R.id.iv_save:
                ...
                if (setWorkingStatusDb == null) {
                    ToastUtil.showToast(WorkSelectSixActivity.this, getResources().getString(R.string.work_no));
                    return;
                }
...
//                userValue1.setGender(commonBean.getGender() + "");
                ...
                HintDialog dialog = new HintDialog(WorkSelectSixActivity.this);
                dialog.loadDialog(WorkSelectSixActivity.this, new HintDialog.OnClickIsConfirm() {
                    @Override
...
//            tv_max.setText(fourHundredModeBean.getFluenceMax()+"");
    ...
    private void resetMenuModeState() {
        tv_auto.setTextColor(getResources().getColor(R.color.work_six_tv));
        tv_30.setTextColor(getResources().getColor(R.color.work_six_tv));
        tv_100.setTextColor(getResources().getColor(R.color.work_six_tv));
        tv_400.setTextColor(getResources().getColor(R.color.work_six_tv));
    }
...
//        tv_max.setText(fourHundredModeBean.getFluenceMax()+"");
    ...
    private void resetMenuRangeState() {
        tv_l.setTextColor(getResources().getColor(R.color.work_six_tv));
        tv_m.setTextColor(getResources().getColor(R.color.work_six_tv));
        tv_f.setTextColor(getResources().getColor(R.color.work_six_tv));
    }
    ...
    public void setSelectFan(int fan_flag){
        ...
        if (fan_flag == 1) {
            ...
            fan_4.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_unselect_corners));
        ...
        if (fan_flag == 4) {
            ...
            fan_2.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_select_corners));
            fan_3.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_select_corners));
            fan_4.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_select_corners));
           fan_5.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_unselect_corners));
        }
        if (fan_flag == 5) {
            fan_1.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_select_corners));
            ...
            fan_3.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_select_corners));
            fan_4.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_select_corners));
            fan_5.setBackground(getResources().getDrawable(R.drawable.work_six_fan_1_select_corners));
        }
    }
