...
public class WorkSelectTwoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_select_two);
//        initView();
//        initIntentData();
//        initData();
    }
...
//            LogUtils.e("倒计时" + DateUtil.getTimeFromInt(autoShedTime * 1000));
    ...
    private void initData() {
        ...
        ll_raedy.setBackground(getResources().getDrawable(R.drawable.work_two_stby_rounded_corners));
        ...
        switch (view.getId()) {
            case R.id.iv_save:
                ...
                if (setWorkingStatusDb == null) {
                    ToastUtil.showToast(WorkSelectTwoActivity.this, getResources().getString(R.string.work_no));
                    return;
                }
                ...
                HintDialog dialog = new HintDialog(WorkSelectTwoActivity.this);
                dialog.loadDialog(WorkSelectTwoActivity.this, new HintDialog.OnClickIsConfirm() {
                    @Override
            ...
            case R.id.iv_setting:
                ...
                startActivity(new Intent(WorkSelectTwoActivity.this, UserSettingActivity.class));
                break;
            case R.id.iv_back:
                finish();
                break;
            case R.id.iv_main:
                ...
                startActivity(new Intent(WorkSelectTwoActivity.this, SplashActivity.class));
                break;
        }
    }
...
//                arcSeekBar
    ...
    public void modeClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.ll_auto:
                ...
                tv_auto.setTextColor(getResources().getColor(R.color.work_two_fan_select));
                getData(AUTOMODE);
                break;
            case R.id.ll_30:
                current_mode_type = THIRTYMODE;
                tv_30.setTextColor(getResources().getColor(R.color.work_two_fan_select));
                getData(THIRTYMODE);
                break;
            case R.id.ll_100:
                current_mode_type = HUNDREDMODE;
                tv_100.setTextColor(getResources().getColor(R.color.work_two_fan_select));
                getData(HUNDREDMODE);
                break;
            case R.id.ll_400:
                current_mode_type = FOURHUNDREDMODE;
                tv_400.setTextColor(getResources().getColor(R.color.work_two_fan_select));
    ...
    private void resetMenuModeState() {
        tv_auto.setTextColor(getResources().getColor(R.color.work_two_fan_unselect));
        tv_30.setTextColor(getResources().getColor(R.color.work_two_fan_unselect));
        tv_100.setTextColor(getResources().getColor(R.color.work_two_fan_unselect));
        tv_400.setTextColor(getResources().getColor(R.color.work_two_fan_unselect));
    }
    ...
    public void rangeClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.ll_l:
                ...
                tv_l.setTextColor(getResources().getColor(R.color.work_two_fan_select));
                break;
            case R.id.ll_m:
                setRangeData(R.id.ll_m);
                tv_m.setTextColor(getResources().getColor(R.color.work_two_fan_select));
                break;
            case R.id.ll_f:
                setRangeData(R.id.ll_f);
                tv_f.setTextColor(getResources().getColor(R.color.work_two_fan_select));
                break;
    ...
    private void resetMenuRangeState() {
        tv_l.setTextColor(getResources().getColor(R.color.work_two_fan_unselect));
        tv_m.setTextColor(getResources().getColor(R.color.work_two_fan_unselect));
        tv_f.setTextColor(getResources().getColor(R.color.work_two_fan_unselect));
    }
    ...
    public void selectClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.iv_fan:
                ...
                if (fan_flag == 1) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_two_fan_1_select_corners));
                }
                if (fan_flag == 2) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_two_fan_1_select_corners));
                    fan_2.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                }
                if (fan_flag == 3) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_two_fan_1_select_corners));
                    fan_2.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                    fan_3.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                }
                if (fan_flag == 4) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_two_fan_1_select_corners));
                    fan_2.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                    fan_3.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                    fan_4.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                }
                if (fan_flag == 5) {
                    setSendFan(fan_flag);
                    fan_flag = 0;
                    ...
                    fan_3.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                    fan_4.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_select_corners));
                    fan_5.setBackground(getResources().getDrawable(R.drawable.work_two_fan_3_select_corners));
                }
                break;
        }
    }
    ...
    private void resetMenuState() {
        fan_1.setBackground(getResources().getDrawable(R.drawable.work_two_fan_1_unselect_corners));
        fan_2.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_unselect_corners));
        fan_3.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_unselect_corners));
        fan_4.setBackground(getResources().getDrawable(R.drawable.work_two_fan_2_unselect_corners));
        fan_5.setBackground(getResources().getDrawable(R.drawable.work_two_fan_3_unselect_corners));
    ...
    public void helloEventBus(UploadWorkingInfo uploadWorkingInfo) {//結果集
        ...
        if (uploadWorkingInfo.getWorkingStatus() == 0) {//stby
            ...
            ll_all.setVisibility(View.VISIBLE);
            LogUtils.e("reading");
            ll_raedy.setBackground(getResources().getDrawable(R.drawable.work_two_read_rounded_corners));
            ...
            ll_all.setVisibility(View.VISIBLE);
            LogUtils.e("working");
            ll_raedy.setBackground(getResources().getDrawable(R.drawable.work_two_working_rounded_corners));
