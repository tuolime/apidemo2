...
public class WorkSelectFourActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_select_four);
        initView();
        initIntentData();
        initData();
    }
    ...
    private void initData() {
        ...
        tv_raedy.setTextColor(getResources().getColor(R.color.mode_four_bt_select));
        ...
        switch (view.getId()) {
            case R.id.iv_save:
                ...
                if (setWorkingStatusDb == null) {
                    ToastUtil.showToast(WorkSelectFourActivity.this, getResources().getString(R.string.work_no));
                    return;
                }
                ...
                HintDialog dialog = new HintDialog(WorkSelectFourActivity.this);
                dialog.loadDialog(WorkSelectFourActivity.this, new HintDialog.OnClickIsConfirm() {
                    @Override
            ...
            case R.id.iv_setting:
                startActivity(new Intent(WorkSelectFourActivity.this, UserSettingActivity.class));
                break;
            case R.id.iv_back:
                finish();
                break;
            case R.id.iv_main:
                startActivity(new Intent(WorkSelectFourActivity.this, SplashActivity.class));
                break;
        }
    }
...
//                arcSeekBar
    ...
    public void modeClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.ll_auto:
                ...
                ll_auto.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_top_select));
                tv_auto.setTextColor(getResources().getColor(R.color.white));
                getData(AUTOMODE);
                break;
            case R.id.ll_30:
                current_mode_type = THIRTYMODE;
                ll_30.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_left_select));
                tv_30.setTextColor(getResources().getColor(R.color.white));
                getData(THIRTYMODE);
                break;
            case R.id.ll_100:
                current_mode_type = HUNDREDMODE;
                ll_100.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_bottom_select));
                tv_100.setTextColor(getResources().getColor(R.color.white));
                getData(HUNDREDMODE);
                break;
            case R.id.ll_400:
                current_mode_type = FOURHUNDREDMODE;
                ll_400.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_right_select));
    ...
    private void resetMenuModeState() {
        ll_auto.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_top_unselect));
        ll_30.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_left_unselect));
        ll_100.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_bottom_unselect));
        ll_400.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_mode_right_unselect));
        tv_auto.setTextColor(getResources().getColor(R.color.mode_four_tv));
        tv_30.setTextColor(getResources().getColor(R.color.mode_four_tv));
        tv_100.setTextColor(getResources().getColor(R.color.mode_four_tv));
        tv_400.setTextColor(getResources().getColor(R.color.mode_four_tv));
    }
    ...
    public void rangeClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.ll_l:
                ...
                ll_l.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_size_left_select));
                tv_l.setTextColor(getResources().getColor(R.color.white));
                break;
            case R.id.ll_m:
                setRangeData(R.id.ll_m);
                ll_m.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_size_bottom_select));
                tv_m.setTextColor(getResources().getColor(R.color.white));
                break;
            case R.id.ll_f:
                setRangeData(R.id.ll_f);
                ll_f.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_size_right_select));
    ...
    private void resetMenuRangeState() {
        ll_l.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_size_left_unselect));
        ll_m.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_size_bottom_unselect));
        ll_f.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_size_right_unselect));
        tv_l.setTextColor(getResources().getColor(R.color.mode_four_tv));
        tv_m.setTextColor(getResources().getColor(R.color.mode_four_tv));
        tv_f.setTextColor(getResources().getColor(R.color.mode_four_tv));
    }
        ...
        switch (view.getId()) {
            case R.id.iv_fan:
                ...
                if (fan_flag == 5) {
                    ...
                    fan_3.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_3_select));
                    fan_4.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_4_select));
                    fan_5.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_5_select));
                }
                break;
        }
    }
    ...
    private void resetMenuState() {
        fan_1.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_1_unselect));
        fan_2.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_2_unselect));
        fan_3.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_3_unselect));
        fan_4.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_4_unselect));
        fan_5.setBackground(getResources().getDrawable(R.mipmap.ic_work_four_fan_5_unselect));
