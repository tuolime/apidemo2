...
public class WorkSelectThreeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_select_three);
//        initView();
//        initIntentData();
//        initData();
    }
...
//            LogUtils.e("倒计时" + DateUtil.getTimeFromInt(autoShedTime * 1000));
    ...
    private void initData() {
        ...
        ll_raedy.setBackground(getResources().getDrawable(R.drawable.work_three_stby_rounded_corners));
        ...
        switch (view.getId()) {
            case R.id.iv_save:
                ...
                if (setWorkingStatusDb == null) {
                    ToastUtil.showToast(WorkSelectThreeActivity.this, getResources().getString(R.string.work_no));
                    return;
                }
                ...
                HintDialog dialog = new HintDialog(WorkSelectThreeActivity.this);
                dialog.loadDialog(WorkSelectThreeActivity.this, new HintDialog.OnClickIsConfirm() {
                    @Override
            ...
            case R.id.iv_setting:
                startActivity(new Intent(WorkSelectThreeActivity.this, UserSettingActivity.class));
                break;
            case R.id.iv_back:
                finish();
                break;
            case R.id.iv_main:
                startActivity(new Intent(WorkSelectThreeActivity.this, SplashActivity.class));
                break;
        }
    }
...
//                arcSeekBar
    ...
    public void modeClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.ll_auto:
                ...
                ll_auto.setBackground(getResources().getDrawable(R.drawable.work_three_mode_1_select_corners));
                getData(AUTOMODE);
                break;
            case R.id.ll_30:
                current_mode_type = THIRTYMODE;
                ll_30.setBackground(getResources().getDrawable(R.drawable.work_three_mode_2_select_corners));
                getData(THIRTYMODE);
                break;
            case R.id.ll_100:
                current_mode_type = HUNDREDMODE;
                ll_100.setBackground(getResources().getDrawable(R.drawable.work_three_mode_2_select_corners));
                getData(HUNDREDMODE);
                break;
            case R.id.ll_400:
                current_mode_type = FOURHUNDREDMODE;
                ll_400.setBackground(getResources().getDrawable(R.drawable.work_three_mode_3_select_corners));
    ...
    private void resetMenuModeState() {
        ll_auto.setBackground(getResources().getDrawable(R.drawable.work_three_mode_1_unselect_corners));
        ll_30.setBackground(getResources().getDrawable(R.drawable.work_three_mode_2_unselect_corners));
        ll_100.setBackground(getResources().getDrawable(R.drawable.work_three_mode_2_unselect_corners));
        ll_400.setBackground(getResources().getDrawable(R.drawable.work_three_mode_3_unselect_corners));
    }
    ...
    public void rangeClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.ll_l:
                ...
                ll_l.setBackground(getResources().getDrawable(R.drawable.work_three_mode_3_select_corners));
                break;
            case R.id.ll_m:
                setRangeData(R.id.ll_m);
                ll_m.setBackground(getResources().getDrawable(R.drawable.work_three_mode_2_select_corners));
                break;
            case R.id.ll_f:
                setRangeData(R.id.ll_f);
                ll_f.setBackground(getResources().getDrawable(R.drawable.work_three_mode_1_select_corners));
                break;
    ...
    private void resetMenuRangeState() {
        ll_l.setBackground(getResources().getDrawable(R.drawable.work_three_mode_3_unselect_corners));
        ll_m.setBackground(getResources().getDrawable(R.drawable.work_three_mode_2_unselect_corners));
        ll_f.setBackground(getResources().getDrawable(R.drawable.work_three_mode_1_unselect_corners));
    }
    ...
    public void selectClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.iv_fan:
                ...
                if (fan_flag == 1) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_three_fan_1_select_corners));
                }
                if (fan_flag == 2) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_three_fan_1_select_corners));
                    fan_2.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                }
                if (fan_flag == 3) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_three_fan_1_select_corners));
                    fan_2.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                    fan_3.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                }
                if (fan_flag == 4) {
                    setSendFan(fan_flag);
                    fan_1.setBackground(getResources().getDrawable(R.drawable.work_three_fan_1_select_corners));
                    fan_2.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                    fan_3.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                    fan_4.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                }
                if (fan_flag == 5) {
                    setSendFan(fan_flag);
                    fan_flag = 0;
                    ...
                    fan_3.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                    fan_4.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_select_corners));
                    fan_5.setBackground(getResources().getDrawable(R.drawable.work_three_fan_3_select_corners));
                }
                break;
        }
    }
    ...
    private void resetMenuState() {
        fan_1.setBackground(getResources().getDrawable(R.drawable.work_three_fan_1_unselect_corners));
        fan_2.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_unselect_corners));
        fan_3.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_unselect_corners));
        fan_4.setBackground(getResources().getDrawable(R.drawable.work_three_fan_2_unselect_corners));
        fan_5.setBackground(getResources().getDrawable(R.drawable.work_three_fan_3_unselect_corners));
    ...
    public void helloEventBus(UploadWorkingInfo uploadWorkingInfo) {//結果集
        ...
        if (uploadWorkingInfo.getWorkingStatus() == 0) {//stby
            ...
            ll_all.setVisibility(View.VISIBLE);
            LogUtils.e("reading");
            ll_raedy.setBackground(getResources().getDrawable(R.drawable.work_three_read_rounded_corners));
